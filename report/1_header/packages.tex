...
%reference list
\usepackage[backend=biber,style=authoryear,sorting=none]{biblatex} %bibliography with IEEE style.
...
% makeglossaries main
% pdflatex main.tex
\usepackage[acronym,nonumberlist,toc,numberedsection=nolabel]{glossaries}
\makeglossaries
