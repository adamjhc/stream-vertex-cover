...
\begin{algorithm}[H]
    ...
    \Func{\FNext{u, v}}{
        ...
        \If{u $\KwIs$ $\KwIn$ \textnormal{matchings} $\KwAnd$ $\FLen{\FNeighbours{u}}$ $\leq$ \textnormal{k}}{
            matchings$[u]$.append((u,v))\;
            isNeighbour $\gets$ True\;
        }
        \If{v $\KwIs$ $\KwIn$ \textnormal{matchings} $\KwAnd$ $\FLen{\FNeighbours{v}}$ $\leq$ \textnormal{k}}{
            matchings$[v]$.append($(u,v)$)\;
            isNeighbour $\gets$ True\;
        }
        \If{$\KwNot$ isNeighbour}{
            matchings.append((u,v))\;
            \If{$\FLen{matchings}$ $>$ \textnormal{k}}{
                \Return False\;
            }
        }
        \Return True\;
