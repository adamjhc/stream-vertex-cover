...
\say{So you might have longer code listings here (you do not need to include your full code listings in the appendices - you will be submitting your code). If you have used, say, a questionnaire this might be a good place to detail every question and your raw data. (Rather than wasting 2+ pages of real content just on listing questions). If you have lots of, say, ERD/UML diagrams then using pages and pages and pages for them might also not be a good use of space.}