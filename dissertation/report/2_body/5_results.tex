...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{benchmark_memory_branching_10_100000_error.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{benchmark_time_branching.png}
...
Kafka is platform agnostic in terms of the connections it allows since
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{stream_kernelization.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{stream_branching.png}
